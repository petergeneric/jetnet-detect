...
public:
    ...
    std::shared_ptr<jetnet::ModelBuilder> create_yolov2(std::string weights_file)
    {
        ...
        return std::make_shared<jetnet::Yolov2Builder<LeakyReluPlugin>>(input_blob_name, output_blob_name, weights_file,
    ...
    std::shared_ptr<jetnet::ModelBuilder> create_yolov3(std::string weights_file)
    {
        ...
        return std::make_shared<jetnet::Yolov3Builder<LeakyReluPlugin>>(input_blob_name, weights_file, nvinfer1::DimsCHW{3,
    ...
    std::shared_ptr<jetnet::ModelBuilder> create_yolov3_tiny(std::string weights_file)
    {
        ...
        return std::make_shared<jetnet::Yolov3TinyBuilder<LeakyReluPlugin>>(input_blob_name, weights_file, nvinfer1::DimsCHW{3,
